...
MODEL_NAME = './object_detection/inference_graph_sc'
CWD_PATH = os.getcwd()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--level_name', type=str, choices=["Soccer_Field_Easy", "Soccer_Field_Medium", "ZhangJiaJie_Medium", "Building99_Hard", 'Final_Tier_1', 'Final_Tier_2', 'Final_Tier_3'], default="Final_Tier_2")
